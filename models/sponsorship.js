...
class Sponsorship {
    ...
    static async create(sponsorshipData) {
        const { sponsorshipId, patientId, donorId, treatmentType, goalAmount, currentAmount, status, createdAt } = sponsorshipData;
        ...
        const query = `INSERT INTO sponsorships (sponsorshipId, patientId, donorId, treatmentType, goalAmount, currentAmount, status, createdAt)
                    VALUES (?, ?, ?, ?, ?, ?, ?, ?)`;
        const values = [sponsorshipId, patientId, donorId, treatmentType, goalAmount, currentAmount, status, createdAt];
